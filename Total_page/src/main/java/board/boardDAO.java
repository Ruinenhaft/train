...
public class boardDAO {
	...
	public void insertBoard(boardDTO bdt) {
		PreparedStatement pstmt = null;//
		Connection conn = null;//
		try {
			conn = DataBaseUtil.getConnection();
			...
			pstmt.setString(2, bdt.getTitle());
			pstmt.setString(3, bdt.getContent());
			pstmt.setString(4, bdt.getName());
			pstmt.setString(5, bdt.getPass());
			pstmt.executeUpdate();
	...
	public void updateContent(boardDTO bdt) {
		boardDTO bb = bdt;
		Connection conn = null;
		PreparedStatement pstmt = null;
